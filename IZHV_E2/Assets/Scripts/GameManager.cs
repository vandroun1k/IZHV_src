...
public class GameManager : MonoBehaviour
{
    ...
    /// <summary>
    /// GameObject used for the game speed text.
    /// </summary>
    ...
    void Update()
    {
        ...
        if (sGameStarted && !mGameLost)
        {
            ...
            // Update the game speed text.
            var currentSpeed = spawner.GetComponent<Spawner>().obstacleAccelerator;
            GetChildNamed(gameSpeedText, "Value").GetComponent<Text>().text = $"{(int)(currentSpeed)}";
        }
    }
