...
public class Spawner : MonoBehaviour
{
    ...
    /// </summary>
    public float spawnFrequencyStd = 0.3f;
    ...
    /// <summary>
    /// accelerates obstacles with time
    /// </summary>
    public float obstacleAccelerator = 0.0f;
    ...
    void Update()
    {
        obstacleAccelerator += Time.deltaTime * 0.040f;

        if (spawnFrequencyMean > 0.5f) 
            spawnFrequencyMean -= Time.deltaTime * 0.0025f;
        if (spawnFrequencyStd < spawnFrequencyMean - 0.1f)
            spawnFrequencyStd += Time.deltaTime * 0.001f;
    ...
    public void SpawnObstacle()
    {
        ...
        // obstacle go brrrr
        obstacle.movementSpeed += obstacleAccelerator;
