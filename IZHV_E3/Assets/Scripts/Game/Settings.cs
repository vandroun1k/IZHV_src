...
public class Settings : MonoBehaviour
{
    ...
    {
        Debug.Log($"Player joined with scheme: {playerInput.currentControlScheme}");
        AddPlayer(playerInput.gameObject);
    }
    
    /// <summary>
    /// Called when a player leaves via PlayerInputManager.
    /// </summary>
    /// <param name="playerInput">The PlayerInput component of the leaving player.</param>
